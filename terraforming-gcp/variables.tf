...
variable "gcp_network" { default = "default" } // change when deploy own infra
variable "gke_master_ipv4_cidr_block" { default = "172.16.0.16/28" }
variable "gcp_subnet_cidr_block_1" { default = "10.0.16.0/20" }
variable "gke_subnet_secondary_cidr_block_0" { default = "10.4.0.0/14" }
variable "gke_subnet_secondary_cidr_block_1" { default = "10.0.32.0/20" }
variable "gcp_subnetwork_name_1" { default = "default" }  // change when deploy own infra
